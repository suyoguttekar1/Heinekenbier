                            ...
                            <div class="alert alert-error hide">
                              ...
                              You have some form errors. Please check below.
                                ...
                                <h3 class="form-section" style="margin-top: -10px; color: #006633">Add New Employee</h3>
									...
									<div class="form-group">
                                        <label for="user_upload" class="col-md-3 control-label">Employee Image </label>
                                        <div class="col-md-9">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="submit" id="submit" name="submit" style="background-color: #006633" class="btn font-white">Add Employee</button>
