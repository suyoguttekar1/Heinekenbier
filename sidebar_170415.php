                ...
                <div class="page-sidebar-wrapper">
	                <div class="page-sidebar navbar-collapse collapse">
	                    <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
	                        ...
	                        <?php 
	                        $drink = false;
	                        if($filename == "drink.php" || $filename == "drink_list.php" || $filename == "drink_edit.php" || $filename == "drink_available.php" || $filename == "drink_sequence.php" || $filename == "drink_daily_limit.php"){ 
	                             $drink = true;
	                        }
	                        ?>
	                        <?php if($drink){ ?>
	                        ...
	                        <?php } ?>
		                            ...
		                            <ul class="sub-menu">
			                            ...
			                            <?php if($filename == "drink_list.php" || $filename == "drink_edit.php"){ ?>
                                            <li class="active"><a href="drink_list.php">Heineken Drink Listing</a></li>
                                        <?php }else{ ?>
                                            <li ><a href="drink_list.php">Heineken Drink Listing</a></li>
                                        <?php } ?>
		                            </ul>
		                    </li>
		                    ...
		                    <?php 
	                        $employee = false;
	                        if($filename == "employee_list.php" || $filename == "employee_mass_upload.php" || $filename == "employee_edit.php" || $filename == "employee.php" || $filename == "employee_view.php"){ 
	                             $employee = true;
	                        }
	                        ?>
	                        <?php if($employee){ ?>
	                        ...
	                        <?php } ?>
		                            ...
		                            <ul class="sub-menu">
			                            ...
			                            <?php if($filename == "employee_edit.php" || $filename == "employee_list.php" || $filename == "employee_view.php"){ ?>
