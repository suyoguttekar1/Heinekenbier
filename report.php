    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                        	...
                                        	<div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group input-large date-picker input-daterange" data-date="2012/10/11" data-date-format="yyyy-mm-dd">
                                                        ...
                                                        <input type="text" class="form-control" name="date_to" id="date_to" value="<?php echo $date_to; ?>"> </div>
                                                    <!-- /input-group -->
                                                    <span class="help-block"> Select date range </span>
                                                </div>
                                                <input type="submit" class="btn" name="submit" id="submit" style="margin-left: 50px; background-color: #006633; color: white;">
                                            </div>
                                        </div>
                                    </form>
                                    <!-- END FORM-->
                                      ...
                                      <br><br>
                                          ...
                                          <div class="row">
                                            <div class="col-md-12" style="margin-top: -20px;">
											  ...
											  <p style="margin-left: 20px; font-size: 17px;">Download full report <a href="report_consumption_download.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" class="btn font-white" style="background-color: #006633">Here</a></p>
        ...
        <!-- BEGIN FOOTER-->
                ...
                $(document).ready(function(){
                  ...
                  $.ajax({
                    url: 'https://hstsmy119491.my1.heiway.net/chart_drink_category.php?date_from='+date1+'&date_to='+date2,
                    method: "GET",
                        ...
                        datasets: [
                          {
                            label: 'Category Name',
                            backgroundColor: [
                              'rgba(0,130,0,0.75)', // Heineken
                              'rgba(28,28,28,0.75)', // Guinness Foreign Extra Stout
                              'rgba(53,8,1,0.75)', // Guinness Draught
                              'rgba(46,234,185,0.75)', // Guinness Bright
                              'rgba(16,5,237,0.75)', // Tiger
                              'rgba(255,224,101,0.75)', // Tiger White
                              'rgba(255,255,0,0.75)', // Tiger Radler
                              'rgba(255,43,0,0.75)', // Anchor Smooth
                              'rgba(222,222,222,0.75)' // Anchor Smooth Draught
                            ],
                            borderColor: [
                              'rgba(0,130,0,1)', // Heineken
                              'rgba(28,28,28,1)', // Guinness Foreign Extra Stout
                              'rgba(53,8,1,1)', // Guinness Draught
                              'rgba(46,234,185,1)', // Guinness Bright
                              'rgba(16,5,237,1)', // Tiger
                              'rgba(255,224,101,1)', // Tiger White
                              'rgba(255,255,0,1)', // Tiger Radler
                              'rgba(255,43,0,1)', // Anchor Smooth
                              'rgba(222,222,222,1)' // Anchor Smooth Draught
                            ],
                ...
                $(document).ready(function(){
                  ...
                  $.ajax({
                    url: 'https://hstsmy119491.my1.heiway.net/chart_drink_category_percentage.php?date_from='+date1+'&date_to='+date2,
                    method: "GET",
                    success: function(data) {
                      console.log(data);
                      var categoryName = [];
                ...
                $(document).ready(function(){
                  ...
                  $.ajax({
                    url: 'https://hstsmy119491.my1.heiway.net/chart_drink_consumption.php?date_from='+date1+'&date_to='+date2,
                    method: "GET",
                    success: function(data) {
                      console.log(data);
                      var drinkName = [];
                        ...
                        datasets: [
                          {
                            ...
                            backgroundColor: [
                              ...
                              'rgba(190,152,0,0.75)', // Anchor Strong
                              'rgba(127,22,0,0.75)', // Kilkenny
                              'rgba(254,203,0,0.75)', // Kirin Ichiban
                              'rgba(234,103,4,0.75)', // Paulaner
                              'rgba(255,233,137,0.75)', // Strongbow Gold
                              'rgba(186,225,143,0.75)', // Strongbow Elderflower
                              'rgba(255,192,0,0.75)', // Strongbow Honey
                              'rgba(106,28,106,0.75)', // Strongbow Dark Fruit
                              'rgba(255,47,5,0.75)', // Smirnoff Ice Red

                              'rgba(95,95,95,0.75)', // Smirnoff Ice Black
                              'rgba(132,61,2,0.75)', // Malta
                              'rgba(251,110,5,0.75)', // Shandy
                            ...
                            borderColor: [
                              ...
                              'rgba(190,152,0,1)', // Anchor Strong
                              'rgba(127,22,0,1)', // Kilkenny
                              'rgba(254,203,0,1)', // Kirin Ichiban
                              'rgba(234,103,4,1)', // Paulaner
                              'rgba(255,233,137,1)', // Strongbow Gold
                              'rgba(186,225,143,1)', // Strongbow Elderflower
                              'rgba(255,192,0,1)', // Strongbow Honey
                              'rgba(106,28,106,1)', // Strongbow Dark Fruit
                              'rgba(255,47,5,1)', // Smirnoff Ice Red

                              'rgba(95,95,95,1)', // Smirnoff Ice Black
                              'rgba(132,61,2,1)', // Malta
                              'rgba(251,110,5,1)', // Shandy
                              'rgba(176,196,222,1)',
                              'rgba(230,230,250,1)',
                              'rgba(255,250,240,1)',
                              'rgba(240,248,255,1)',
