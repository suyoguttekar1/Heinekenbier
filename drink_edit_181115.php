...
if( !$con ) {
	...
	$sql = "
	select t.code, t.drink_category, t.drink_name, t.pint, t.display_seq, isnull(t.image_url,'http://mobileapps.heinekenmalaysia.com/img/default.png') as image_url, t.valid_flag 
        ...
        function sendForm(form){
            return PLX.Submit(form, {
                ...
                "onFinish": function(response){
                  if(response == 'Drink success updated') { 
					  alert(response);
                ...
                <div class="page-content">
                    ...
                    <div class="tab-content">
                        <div class="portlet box white">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="includes/class/drink_c_edit.php" method="post" name="create_user" id="create_user" class="form-horizontal" onSubmit="return sendForm(this);" enctype="multipart/form-data" data-toggle="validator">
                              ...
                              You have some form errors. Please check below.
                                ...
                                <h3 class="form-section" style="margin-top: -10px; color: #006633">Edit Drink </h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" id="drink_category" name="drink_category" required>
                                                <option value="1" <?php if($t_drink_category=="1") echo 'selected="selected"'; ?>> Beer </option>
                                                <option value="4" <?php if($t_drink_category=="4") echo 'selected="selected"'; ?>> Stout </option>
												<option value="5" <?php if($t_drink_category=="5") echo 'selected="selected"'; ?>> Cider </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" id="drink_name" name="drink_name" required value="<?php echo $t_drink_name; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" id="display_seq" name="display_seq" value="<?php echo $t_display_seq; ?>" readonly>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" id="valid_flag" name="valid_flag" required>
                                                <option value="Y"<?php if($t_drink_valid_flag=="Y") echo 'selected="selected"'; ?>> Available </option>
                                                <option value="N"<?php if($t_drink_valid_flag=="N") echo 'selected="selected"'; ?>> Out of Stock </option>
                                            </select>
                                        </div>
                                    </div>
									...
									<div class="form-group">
	                                    <div>
	                                        <label class="col-md-3 control-label">Drink Photo<br>480x480 .jpg</label>
	                                    </div>
                                        <div class="col-md-8">
                                            <img src="<?php echo $t_image_url; ?>"  height="240" width="240" style="border: 1px solid; border-color: lightgrey;">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="user_upload" class="col-md-3 control-label">Update Drink Photo<br>480x480 jpg <br><a href="http://mobileapps.heinekenmalaysia.com/img/Heineken_Drink.psd" target="_blank">Download sample .psd</a></label>
                                        <div class="col-md-9">
                                            <input type="file" id="user_upload" name="user_upload" class="default">
                                            <p>Click "Choose File" to select image...</p>
                                        </div>
                                    </div>
