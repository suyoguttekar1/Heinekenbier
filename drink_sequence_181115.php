...
if(isset($_POST["submit"])) {
  ...
  sqlsrv_free_stmt($result2);
		...
		$query = "select * from drinks order by display_seq";
...
<head>
  ...
  <script src="assets/pages/scripts/jquery-1.10.2.js"></script>
  <script src="assets/pages/scripts/jquery-ui.js"></script>
  <style>
  /*body{width:610px;}*/
  #sortable-row { list-style: none; }
  #sortable-row li { margin-bottom:4px; padding:10px; background-color:#64D19A;cursor:move;border-radius: 5px;}
  /*.btnSave{padding: 10px 20px;background-color: #09F;border: 0;color: #FFF;cursor: pointer;margin-left:40px;}  */
  #sortable-row li.ui-state-highlight { height: 1.0em; background-color:#F0F0F0;border:#ccc 2px dotted; width: 400px;}
  </style>
  <script>
  $(function() {
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="drink_list.php">Drink Listing</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="portlet-body form">
                          <div class="form-body">
                            ...
                            <!--<p style="font-size: 17px;">Please sort the drink sequence by dragging the drink name up and down. Drink on top will display first on the iPad ordering menu. Please press "Save Sequence" button to apply the change.</p> -->
							<p style="font-size: 17px;">1) Sort the drinks by drag and drop.<br>2) Press Save button to apply changes.</p>
                            <br>
                            ...
                            <br>
                            <button type="button" class="btn font-white" style="background-color: #006633; margin-left: 40px;" onClick="return btncancel_onclick()">Cancel</button>
                            <button type="submit" class="btn font-white" name="submit" style="background-color: #006633;" value="Save Order" onClick="saveOrder();">Save</button>
