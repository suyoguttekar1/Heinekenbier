                ...
                <div class="page-content">
                    ...
                    <div class="tab-content">
                        <div class="portlet box white">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="#" method="post" name="edit_user" id="edit_user" class="form-horizontal" onSubmit="return sendForm(this);" enctype="multipart/form-data" data-toggle="validator">
                            ...
                            <div class="alert alert-error hide">
                              ...
                              You have some form errors. Please check below.
                                ...
                                <div class="form-body">
                                <h3 class="form-section" style="margin-top: -10px; color: #006633">Edit User</h3>
                                    ...
                                    <div class="form-group">
	                                    ...
	                                    <div>
	                                        <label class="col-md-3 control-label">Employee Name <b class="required">*</b></label>
	                                            
	                                    </div>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="employee_name" name="employee_name" value="" required>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
	                                    <div>
	                                        <label class="col-md-3 control-label">Employee IC <b class="required">*</b></label>
	                                            
	                                    </div>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="employee_ic" name="employee_ic" value="" required>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="submit" id="submit" name="submit" style="background-color: #006633" class="btn font-white">Edit User</button>
