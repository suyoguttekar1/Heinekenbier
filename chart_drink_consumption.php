...
//in params: key, ipad_id
  ...
  $sql = "
	select d.display_seq, d.drink_name, count(t.drink_code) drink_count 
	from order_drink_detail t 
	right outer join drinks d
	on d.code = t.drink_code
	and t.tran_date between ? and ?
	group by d.display_seq, d.drink_name
