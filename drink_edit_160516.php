                              ...
                              You have some form errors. Please check below.
                                ...
                                <h3 class="form-section" style="margin-top: -10px; color: #006633">Edit Drink </h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" id="display_seq" name="display_seq" value="<?php echo $t_display_seq; ?>">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <img src="<?php echo $t_image_url; ?>"  height="480" width="480">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="user_upload" class="col-md-3 control-label">Update Drink Photo </label>
                                        <div class="col-md-9">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="submit" id="submit" name="submit" style="background-color: #006633" class="btn font-white">Update Drink</button>
