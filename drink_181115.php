                            ...
                            <div class="alert alert-error hide">
                              ...
                              You have some form errors. Please check below.
                                ...
                                <h3 class="form-section" style="margin-top: -10px; color: #006633">Add New Drink</h3>
                                    ...
                                    <div class="form-group">
                                        <label for="user_upload" class="col-md-3 control-label">Drink Image<br/>(480x480px, jpg only)<br/><a href="http://mobileapps.heinekenmalaysia.com/img/Heineken_Drink.psd" target="_blank">Download sample .psd</a> <b class="required">*</b></label>
                                        <div class="col-md-9">
